...
<body style="font-family: tahoma; background-color:#d0d8e4;">
    ...
    <div style="display: flex;">
     <!---friends area --->
        ...
        <div id="friends_bar">
                <img src="img/selfie.jpg" id="profile_pic"><br>
        ...
        <!---posts --->
            <div id="post_bar">
                ...
                <div id="post">
                    <div>
                        <img src="img/user1.jpg" style="width: 75px; margin-right: 4px;">
                    </div>
                ...
                <div id="post">
                    <div>
                        <img src="img/user4.jpg" style="width: 75px; margin-right: 4px;">
                    </div>
