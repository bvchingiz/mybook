...
<body style="font-family: tahoma; background-color:#d0d8e4;">
    ...
    <div style="background_color: white;  text-align: center; color: #405d9b">
       
    <img src="img/mountain.jpg" style="width: 100%;">
        <span style="font-size: 12px;">
             <img id="profile_pic" src="img/selfie.jpg"> </br>
             <a style="text-decoration: none; color: #f0f;" href="change_profile_image.php"> Change image </a>
        </span>  
        <br>
        <div style="font-size: 25px; color: black;"><?php echo $user_data['first_name'] . " " . $user_data['last_name'] ?> </div>
        <br>
